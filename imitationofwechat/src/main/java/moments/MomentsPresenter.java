...
import data.source.MomentsLoader;
import util.CommonUtil;
import util.DataUtil;
import views.CommentsTextView;
...
public class MomentsPresenter implements MomentsContract.Presenter, LoaderManager.LoaderCallbacks<List<MomentBean>> {
    ...
    @Override
    public void onLoadFinished(Loader<List<MomentBean>> loader, List<MomentBean> data) {
    ...
    @Override
    public void onLoaderReset(Loader<List<MomentBean>> loader) {
