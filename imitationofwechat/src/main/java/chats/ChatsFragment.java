...
import Interface.OnItemLongClickListener;
import adapter.ChatsListAdapter;
import beans.ChatBean;
import data.source.local.WeChatDBHelper;
...
//    置顶聊天的数目
    ...
    public void showChat(int contactId) {
        Intent intent = new Intent(mContext, chat.ChatActivity.class);
        intent.putExtra(chat.ChatActivity.INTENT_KEY_CONTACT_ID,contactId);
