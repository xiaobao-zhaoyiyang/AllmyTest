    ...
    public void showMorePanelItem(int position) {
        switch (position){
            case 0:
                ...
                intent.putExtra(ChooseImageActivity.KEY_SELECT_MODE, chooseImage.ChooseImageActivity.MODE_MULTIPLE);
